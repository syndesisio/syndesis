...
syntax. In this release, a conditional expression that refers to a field 
that is a collection causes an error. It is expected that a future 
release will support a conditional expression that refers to a field that 
is a collection. 
