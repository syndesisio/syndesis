...
that {prodname} opens:
+
ifdef::integrating-applications-with-fuse-online[]
...
endif::integrating-applications-with-fuse-online[]
ifdef::developing-and-deploying-apis-with-red-hat-integration[]
.. Define the OpenAPI document as described in
link:{LinkIntegrationDevDeploy}#p_creating_api_{context}[Creating a REST API definition in API Designer].
endif::developing-and-deploying-apis-with-red-hat-integration[]
