...
*Note:* After you add a condition to a mapping, the Source and Target transformation options are disabled. If need to place any transformations within the conditional expression.
