...
. After adding the required data mapper steps, look for any
image:images/tutorials/WarningIcon.png[Warning] icons. This warning indicates that the data mapper step added in step 7 (above), must be edited. 
+
