...
.. In the *TaskAPI* entry, click *View* to display the integration's summary. 
.. In the upper right, click *Edit Integration* to display a list
of the operations that this API provides. 
.. Update one step in the flow for the *Create new task* operation: 
... In the *POST* entry for the *Create new task* operation, click *Create flow* to display 
