...
= Using Camel Simple Language to specify conditions
...
described here shows how to use Camel Simple Language to 
specify conditions. 
...
.. In the initial *When* field, enter a Camel Simple Language expression. For example, 
...
For details about Camel Simple Language operators, see  
