...
|Salesforce developer account, sample `todo` application enabled, and sample Postgres database enabled
|Sample `todo` application and sample Postgres database enabled 
