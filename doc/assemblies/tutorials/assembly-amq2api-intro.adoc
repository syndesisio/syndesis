...
an administrator added the {prodname} sample data, which provides the sample *PostgresDB* connection and the *To Do* app for confirming that the integration works as expected.
endif::[]
