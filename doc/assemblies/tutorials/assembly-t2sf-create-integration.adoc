...
include::../../modules/tutorials/proc-t2sf-choose-start.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-t2sf-choose-finish.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-t2sf-add-filter-step.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-t2sf-add-mapping-step.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-t2sf-name-and-publish.adoc[leveloffset=+1]
