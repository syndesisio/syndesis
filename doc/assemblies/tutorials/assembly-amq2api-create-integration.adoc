...
include::../../modules/tutorials/proc-amq2api-choose-start.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-amq2api-choose-finish.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-amq2api-add-damage-reporter-step.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-amq2api-add-mapping-step.adoc[leveloffset=+1]

include::../../modules/tutorials/proc-amq2api-name-and-publish.adoc[leveloffset=+1]
