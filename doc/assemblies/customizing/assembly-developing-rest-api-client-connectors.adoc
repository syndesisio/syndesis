...
include::../../modules/customizing/con-about-api-connectors.adoc[leveloffset=+1]

include::../../modules/customizing/con-guidelines-for-openapi-documents.adoc[leveloffset=+1]

// include::access-token-strategy.adoc[leveloffset=+1]

include::../../modules/customizing/ref-providing-client-credentials.adoc[leveloffset=+1]

include::../../modules/customizing/ref-refreshing-access-tokens.adoc[leveloffset=+1]
