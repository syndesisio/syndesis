...
include::../../modules/connecting/proc-obtaining-aws-credentials.adoc[leveloffset=+1]

include::assembly-connecting-to-amazon-dynamodb.adoc[leveloffset=+1]

include::assembly-connecting-to-amazon-sns.adoc[leveloffset=+1]

include::assembly-connecting-to-amazon-sqs.adoc[leveloffset=+1]

include::assembly-connecting-to-amazon-s3.adoc[leveloffset=+1]
