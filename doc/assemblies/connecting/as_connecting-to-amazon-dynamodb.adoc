...
An integration can retrieve data from an Amazon DynamoDB table, insert 
or update data in a DynamoDB table, or remove an item from a DynamoDB 
...
* xref:adding-dynamodb-connection-delete_{context}[]
...
include::../../modules/connecting/p_adding-dynamodb-connection-delete.adoc[leveloffset=+1]
