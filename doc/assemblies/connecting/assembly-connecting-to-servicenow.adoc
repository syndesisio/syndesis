...
include::../../modules/connecting/proc-create-servicenow-connection.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-servicenow-connection-start.adoc[leveloffset=+1]

include::../../modules/connecting/proc-create-servicenow-import-set.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-servicenow-connection-finish.adoc[leveloffset=+1]

include::../../modules/connecting/ref-example-sf-servicenow-integration.adoc[leveloffset=+1]
