...
include::../../modules/connecting/proc-register-with-box.adoc[leveloffset=+1]

include::../../modules/connecting/proc-creating-box-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-box-connection-middle.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-box-connection-finish.adoc[leveloffset=+1]
