...
include::../../modules/connecting/proc-creating-mqtt-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-mqtt-connection-start.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-mqtt-connection-finish-middle.adoc[leveloffset=+1]
