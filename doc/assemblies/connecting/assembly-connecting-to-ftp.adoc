...
For the middle or last step in an integration, you can download or upload a named file (where the previous step in the integration provides the name of the file). You can also upload files that you define with an Apache Camel File Language expression.
