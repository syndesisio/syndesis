...
include::../../modules/connecting/proc-creating-http-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-http-connections.adoc[leveloffset=+1]
