...
include::../../modules/connecting/proc-register-with-dropbox.adoc[leveloffset=+1]

include::../../modules/connecting/proc-create-dropbox-connection.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-dropbox-connection-start.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-dropbox-connection-finish.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-dropbox-connection-middle.adoc[leveloffset=+1]
