...
include::../../modules/connecting/proc-creating-fhir-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-fhir-connection-read.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-fhir-connection-search.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-fhir-connection-create.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-fhir-connection-update.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-fhir-connection-patch.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-fhir-connection-transaction.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-fhir-connection-delete.adoc[leveloffset=+1]
