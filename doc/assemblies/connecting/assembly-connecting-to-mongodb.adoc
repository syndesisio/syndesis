...
include::../../modules/connecting/proc-creating-mongodb-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-mongodb-connections-read.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-mongodb-connections-write.adoc[leveloffset=+1]
