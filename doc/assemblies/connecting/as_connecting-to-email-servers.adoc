...
An integration can retrieve messages from an IMAP or POP3 email server or 
connect to an SMTP email server to send messages. To trigger integration
...
include::../../modules/connecting/p_creating-a-connection-to-an-imap-or-pop3-email-server.adoc[leveloffset=+1]

include::../../modules/connecting/p_creating-a-connection-to-an-smtp-email-server.adoc[leveloffset=+1]

include::../../modules/connecting/p_obtaining-email-to-trigger-integration-execution.adoc[leveloffset=+1]

include::../../modules/connecting/p_sending-email-from-an-integration.adoc[leveloffset=+1]
