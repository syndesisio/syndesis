...
include::../../modules/connecting/proc-registering-with-jira.adoc[leveloffset=+1]

include::../../modules/connecting/proc-creating-jira-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-jira-connection-start.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-jira-connection-add-issue.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-jira-connection-add-comment.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-jira-connection-attach-file.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-jira-connection-watchers.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-jira-connection-update-issue.adoc[leveloffset=+1]

include::../../modules/connecting/proc-adding-jira-connection-transition-issue.adoc[leveloffset=+1]
