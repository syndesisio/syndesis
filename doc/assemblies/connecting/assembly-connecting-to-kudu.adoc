...
include::../../modules/connecting/proc-create-kudu-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-kudu-connection-get-records.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-kudu-connection-add-records.adoc[leveloffset=+1]
