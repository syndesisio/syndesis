...
include::../../modules/connecting/proc-creating-slack-connections.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-slack-connection-start.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-slack-connection-middle-finish.adoc[leveloffset=+1]
