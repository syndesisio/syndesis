...
include::../../modules/connecting/proc-register-with-google.adoc[leveloffset=+1]

include::assembly-connecting-to-gmail.adoc[leveloffset=+1]

include::assembly-connecting-to-google-calendar.adoc[leveloffset=+1]

include::assembly-connecting-to-google-sheets.adoc[leveloffset=+1]
