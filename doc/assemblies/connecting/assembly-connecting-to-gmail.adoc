...
include::../../modules/connecting/proc-create-gmail-connection.adoc[leveloffset=+1]

include::../../modules/connecting/ref-alternatives-for-populating-email-to-send.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-gmail-connection-start.adoc[leveloffset=+1]

include::../../modules/connecting/proc-add-gmail-connection-finish-middle.adoc[leveloffset=+1]
