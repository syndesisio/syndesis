...
* xref:example-of-separating-one-field-into-multiple-fields_{context}[]
...
include::../../modules/integrating-applications/r_example-of-separating-one-field-into-multiple-fields.adoc[leveloffset=+1]
