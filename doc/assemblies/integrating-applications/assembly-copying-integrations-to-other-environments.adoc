...
include::../../modules/integrating-applications/con-about-copying-integrations.adoc[leveloffset=+1]

include::../../modules/integrating-applications/proc-exporting-integrations.adoc[leveloffset=+1]

include::../../modules/integrating-applications/proc-importing-integrations.adoc[leveloffset=+1]
