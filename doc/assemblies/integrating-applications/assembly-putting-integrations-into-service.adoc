...
include::../../modules/integrating-applications/ref-publishing-integrations.adoc[leveloffset=+1]

include::../../modules/integrating-applications/proc-stopping-integrations.adoc[leveloffset=+1]

include::../../modules/integrating-applications/proc-starting-integrations.adoc[leveloffset=+1]

include::../../modules/integrating-applications/proc-restarting-older-integration-versions.adoc[leveloffset=+1]
