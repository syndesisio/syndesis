...
include::../../modules/integrating-applications/ref-about-transformations-on-multiple-source-values.adoc[leveloffset=+1]

include::../../modules/integrating-applications/proc-applying-conditions-to-mappings.adoc[leveloffset=+1]

include::../../modules/integrating-applications/ref-available-transformations.adoc[leveloffset=+1]
