...
* <<connecting-to-amazon-sns_{context}>>
* <<connecting-to-amazon-sqs_{context}>>
...
include::topics/as_connecting-to-amazon-sns.adoc[leveloffset=+1]

include::topics/as_connecting-to-amazon-sqs.adoc[leveloffset=+1]
