...
include::p_adding-amqp-connection-start.adoc[leveloffset=+1]

include::p_adding-amqp-connection-finish.adoc[leveloffset=+1]

include::p_adding-amqp-connection-middle.adoc[leveloffset=+1]
