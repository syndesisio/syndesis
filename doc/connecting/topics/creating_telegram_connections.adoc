...
In an integration, a Telegram connection can receive messages from a 
chat bot that you specify or send a message to the same chat by using the bot. 
You can use the same Telegram connection in any number of integrations. 
