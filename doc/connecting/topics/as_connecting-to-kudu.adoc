...
records from a table or to add records to a table. 
...
include::p_add-kudu-connection-get-records.adoc[leveloffset=+1]

include::p_add-kudu-connection-add-records.adoc[leveloffset=+1]
