...
When this limitation is removed then you can change the previous `POST` example to 
...
In this release, this example works only if you create an extension
that accesses the query parameters. 
