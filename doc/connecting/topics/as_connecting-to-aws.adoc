...
An integration can connect to the following Amazon web services: 
...
include::p_obtaining-aws-credentials.adoc[leveloffset=+1]

include::as_connecting-to-amazon-s3.adoc[leveloffset=+1]

include::as_connecting-to-amazon-sns.adoc[leveloffset=+1]

include::as_connecting-to-amazon-sqs.adoc[leveloffset=+1]
