...
If you want to deploy to https://www.openshift.org/minishift/[Minishift] the <<syndesis-minishift,syndesis minishift>> command is recommended as it supports some additional features specific to Minishift.
...
----
syndesis deploy --route syndesis.192.168.64.12.nip.io --tag 1.2
----
...
# Check the project you want to deploy to
oc project                                                        <4>
