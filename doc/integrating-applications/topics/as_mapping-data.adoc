...
* xref:applying-a-condition-to-a-mapping_{context}[]
...
include::p_using-data-mapper-to-process-collections.adoc[leveloffset=+1]

include::r_mapping-between-collections-and-non-collections.adoc[leveloffset=+1]

include::p_transform-target-data.adoc[leveloffset=+1]

include::p_applying-a-condition-to-a-mapping.adoc[leveloffset=+1]

include::p_view-mappings-in-a-step.adoc[leveloffset=+1]

include::r_available-transformations.adoc[leveloffset=+1]

include::r_troubleshooting-data-mapping.adoc[leveloffset=+1]
