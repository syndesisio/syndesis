...
The prompts that {prodname} displays can be any of the following: 
...
.. *API Key* — If the API service requires an API key, you just need 
to select this checkbox. Later, when you use this 
