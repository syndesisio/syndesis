...
// connecting connecting_to_twitter.adoc
...
After you create a Twitter connection, you can use it in multiple 
integrations.
...
* You already registered your {prodname} environment as an application
that can access Twitter. If you did not already register {prodname}, 
see <<register-with-twitter_{context}>>.
