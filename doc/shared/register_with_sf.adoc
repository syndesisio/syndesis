...
client and created a Salesforce connection, skip to <<create-twitter-sf-integration_{context}>>.
endif::[]

ifeval::["{context}" == "sf2db"]
If you already registered {prodname} as a Salesforce
client and created a Salesforce connection, skip to  <<create-sf-db-integration_{context}>>.
endif::[]
