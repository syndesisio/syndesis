...
+
However, for custom connectors, when the `kind` property is set to any, 
...
You can specify the kind of the data shape’s schema, the appropriate 
document for the schema you specify, and a name for the data type. 
