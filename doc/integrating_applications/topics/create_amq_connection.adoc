...
.. In the *Username* field, enter the username for the account you want
to use to access this JMS broker. 
.. In the *Password* field, enter the password for the account you want
to use to access this JMS broker. 
...
should not select this for secure production 
environments. 
