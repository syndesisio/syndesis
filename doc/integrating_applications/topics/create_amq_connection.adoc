...
environments. 
.. In the *Broker Certificate* field, paste the AMQ broker's PEM certificate text.
.. In the *Client Certificate* field, paste the AMQ client's PEM certificate text. 
