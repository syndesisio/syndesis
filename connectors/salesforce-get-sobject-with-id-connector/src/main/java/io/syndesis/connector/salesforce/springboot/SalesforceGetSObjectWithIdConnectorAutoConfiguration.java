...
public class SalesforceGetSObjectWithIdConnectorAutoConfiguration {
    ...
    @ConditionalOnMissingBean(io.syndesis.connector.salesforce.SalesforceGetSObjectWithIdComponent.class)
    public SalesforceGetSObjectWithIdComponent configureSalesforceGetSObjectWithIdComponent(
            CamelContext camelContext,
            SalesforceGetSObjectWithIdConnectorConfiguration configuration)
            throws Exception {
