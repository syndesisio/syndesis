...
public class ActiveMQRequestTextConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQRequestTextComponent>> customizers;
    ...
    public void postConstructActiveMQRequestTextComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQRequestTextConnectorConfigurationCommon> entry : configuration
