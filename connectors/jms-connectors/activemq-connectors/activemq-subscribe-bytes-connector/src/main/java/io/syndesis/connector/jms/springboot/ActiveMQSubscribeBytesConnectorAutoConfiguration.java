...
public class ActiveMQSubscribeBytesConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQSubscribeBytesComponent>> customizers;
    ...
    public ActiveMQSubscribeBytesComponent configureActiveMQSubscribeBytesComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ConnectorCustomizer<ActiveMQSubscribeBytesComponent> customizer : customizers) {
    ...
    public void postConstructActiveMQSubscribeBytesComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQSubscribeBytesConnectorConfigurationCommon> entry : configuration
