...
public class SalesforceDeleteSObjectConnectorAutoConfiguration {
    ...
    @ConditionalOnMissingBean(io.syndesis.connector.salesforce.SalesforceDeleteSObjectComponent.class)
    public SalesforceDeleteSObjectComponent configureSalesforceDeleteSObjectComponent(
            CamelContext camelContext,
            SalesforceDeleteSObjectConnectorConfiguration configuration)
            throws Exception {
