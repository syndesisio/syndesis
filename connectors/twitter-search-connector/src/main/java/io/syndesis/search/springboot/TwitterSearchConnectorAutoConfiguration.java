...
import io.syndesis.search.TwitterSearchComponent;
...
public class TwitterSearchConnectorAutoConfiguration {
    ...
    @ConditionalOnMissingBean(io.syndesis.search.TwitterSearchComponent.class)
    public TwitterSearchComponent configureTwitterSearchComponent(
            CamelContext camelContext,
            TwitterSearchConnectorConfiguration configuration) throws Exception {
