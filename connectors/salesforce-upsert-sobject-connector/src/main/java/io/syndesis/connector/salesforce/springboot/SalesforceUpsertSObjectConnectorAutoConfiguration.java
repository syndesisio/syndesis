...
public class SalesforceUpsertSObjectConnectorAutoConfiguration {
    ...
    @ConditionalOnMissingBean(io.syndesis.connector.salesforce.SalesforceUpsertSObjectComponent.class)
    public SalesforceUpsertSObjectComponent configureSalesforceUpsertSObjectComponent(
            CamelContext camelContext,
            SalesforceUpsertSObjectConnectorConfiguration configuration)
            throws Exception {
