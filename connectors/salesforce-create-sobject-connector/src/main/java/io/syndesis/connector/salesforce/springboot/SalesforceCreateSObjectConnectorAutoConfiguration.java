...
public class SalesforceCreateSObjectConnectorAutoConfiguration {
    ...
    @ConditionalOnMissingBean(io.syndesis.connector.salesforce.SalesforceCreateSObjectComponent.class)
    public SalesforceCreateSObjectComponent configureSalesforceCreateSObjectComponent(
            CamelContext camelContext,
            SalesforceCreateSObjectConnectorConfiguration configuration)
            throws Exception {
