...
public class ActiveMQRespondMapConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQRespondMapComponent>> customizers;
    ...
    public void postConstructActiveMQRespondMapComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQRespondMapConnectorConfigurationCommon> entry : configuration
