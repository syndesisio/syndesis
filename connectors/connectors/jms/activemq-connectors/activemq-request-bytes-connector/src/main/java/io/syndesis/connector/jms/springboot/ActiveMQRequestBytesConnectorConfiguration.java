...
public class ActiveMQRequestBytesConnectorConfiguration
     ...
     */
    private Map<String, ActiveMQRequestBytesConnectorConfigurationCommon> configurations = new HashMap<>();

    public Map<String, ActiveMQRequestBytesConnectorConfigurationCommon> getConfigurations() {
