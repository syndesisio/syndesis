...
public class SqlStartDataSourceCustomizer implements ConnectorCustomizer<SqlStartConnectorComponent> {

    @Autowired
    private SqlStartConnectorConnectorConfiguration configuration;

    @Override
    public void customize(SqlStartConnectorComponent component) {
