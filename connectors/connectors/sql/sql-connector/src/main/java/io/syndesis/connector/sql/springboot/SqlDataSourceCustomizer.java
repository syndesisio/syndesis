...
@Configuration
@EnableConfigurationProperties(SqlConnectorConnectorConfiguration.class)
public class SqlDataSourceCustomizer implements ConnectorCustomizer<SqlConnectorComponent> {

    @Autowired
    private SqlConnectorConnectorConfiguration configuration;

    @Override
    public void customize(SqlConnectorComponent component) {
