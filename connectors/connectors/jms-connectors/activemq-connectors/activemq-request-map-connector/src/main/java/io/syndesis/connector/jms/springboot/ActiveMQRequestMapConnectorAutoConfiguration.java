...
public class ActiveMQRequestMapConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQRequestMapComponent>> customizers;
    ...
    public ActiveMQRequestMapComponent configureActiveMQRequestMapComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ConnectorCustomizer<ActiveMQRequestMapComponent> customizer : customizers) {
    ...
    public void postConstructActiveMQRequestMapComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQRequestMapConnectorConfigurationCommon> entry : configuration
