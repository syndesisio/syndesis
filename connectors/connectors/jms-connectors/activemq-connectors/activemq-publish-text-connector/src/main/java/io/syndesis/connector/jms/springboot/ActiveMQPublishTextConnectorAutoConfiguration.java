...
public class ActiveMQPublishTextConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQPublishTextComponent>> customizers;
    ...
    public ActiveMQPublishTextComponent configureActiveMQPublishTextComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ConnectorCustomizer<ActiveMQPublishTextComponent> customizer : customizers) {
    ...
    public void postConstructActiveMQPublishTextComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQPublishTextConnectorConfigurationCommon> entry : configuration
