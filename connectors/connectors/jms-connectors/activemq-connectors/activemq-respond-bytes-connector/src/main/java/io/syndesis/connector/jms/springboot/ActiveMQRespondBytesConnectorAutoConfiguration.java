...
public class ActiveMQRespondBytesConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQRespondBytesComponent>> customizers;
    ...
    public ActiveMQRespondBytesComponent configureActiveMQRespondBytesComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ConnectorCustomizer<ActiveMQRespondBytesComponent> customizer : customizers) {
    ...
    public void postConstructActiveMQRespondBytesComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQRespondBytesConnectorConfigurationCommon> entry : configuration
