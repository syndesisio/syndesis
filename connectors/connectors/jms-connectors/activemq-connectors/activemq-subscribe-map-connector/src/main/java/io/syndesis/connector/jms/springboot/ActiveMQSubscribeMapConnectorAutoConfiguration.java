...
public class ActiveMQSubscribeMapConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQSubscribeMapComponent>> customizers;
    ...
    public ActiveMQSubscribeMapComponent configureActiveMQSubscribeMapComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ConnectorCustomizer<ActiveMQSubscribeMapComponent> customizer : customizers) {
    ...
    public void postConstructActiveMQSubscribeMapComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQSubscribeMapConnectorConfigurationCommon> entry : configuration
