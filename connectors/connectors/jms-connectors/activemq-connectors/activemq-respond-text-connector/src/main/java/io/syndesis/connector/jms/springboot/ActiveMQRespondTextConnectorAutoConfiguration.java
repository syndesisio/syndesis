...
public class ActiveMQRespondTextConnectorAutoConfiguration {
    ...
    private List<ConnectorCustomizer<ActiveMQRespondTextComponent>> customizers;
    ...
    public void postConstructActiveMQRespondTextComponent() {
        Map<String, Object> parameters = new HashMap<>();
        for (Map.Entry<String, ActiveMQRespondTextConnectorConfigurationCommon> entry : configuration
