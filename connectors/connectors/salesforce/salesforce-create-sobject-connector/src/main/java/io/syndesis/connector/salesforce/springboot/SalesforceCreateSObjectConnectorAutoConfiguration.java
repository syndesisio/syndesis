...
import io.syndesis.connector.salesforce.SalesforceCreateSObjectComponent;
...
@EnableConfigurationProperties(SalesforceCreateSObjectConnectorConfiguration.class)
public class SalesforceCreateSObjectConnectorAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(SalesforceCreateSObjectConnectorAutoConfiguration.class);
    @Autowired
    private ApplicationContext applicationContext;
    @Autowired
    private CamelContext camelContext;
    @Autowired
    private SalesforceCreateSObjectConnectorConfiguration configuration;
    @Autowired(required = false)
    private List<ConnectorCustomizer<SalesforceCreateSObjectComponent>> customizers;
