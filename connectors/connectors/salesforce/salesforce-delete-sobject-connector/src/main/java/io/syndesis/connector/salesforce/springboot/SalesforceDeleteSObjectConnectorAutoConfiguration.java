...
public class SalesforceDeleteSObjectConnectorAutoConfiguration {
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(SalesforceDeleteSObjectConnectorAutoConfiguration.class);
    @Autowired
    ...
    private List<ConnectorCustomizer<SalesforceDeleteSObjectComponent>> customizers;
                    ...
                    for (ConnectorCustomizer<SalesforceDeleteSObjectComponent> customizer : customizers) {
                        boolean useCustomizer = (customizer instanceof HasId)
                                ? HierarchicalPropertiesEvaluator.evaluate(
                                        applicationContext.getEnvironment(),
                                        "camel.connector.customizer",
                                        "camel.connector.salesforce-delete-sobject."
                                                + entry.getKey()
                                                + ".customizer",
                                        ((HasId) customizer).getId())
                                : HierarchicalPropertiesEvaluator.evaluate(
