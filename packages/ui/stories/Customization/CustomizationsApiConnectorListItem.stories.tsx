...
import { CustomizationsApiConnectorListItem } from '../../src';
import { apiConnectorDetailsStory } from './CustomizationsApiConnectorDetail.stories';

const stories = storiesOf(
  'Customization/CustomizationsApiConnectorListItem',
  module
);
...
const apiName = 'Beer API 2.0';

const deleteText = 'Delete';
const deleteActionText = deleteText + ' ' + apiName;
const deleteTip = 'Delete this API connector';
const detailsText = 'Details';
const detailsTip = 'View API connector details';
const usedByFive = 5;
...
const inUseTestNotes =
  '- Verify API icon is showing on the left\n' +
  '- Verify API name is "' +
  apiName +
  '"\n' +
  '- Verify API description is "' +
  apiDescription +
  '"\n' +
  '- Verify the usage message is "' +
  usedByFiveMsg +
  '"\n' +
  '- Verify there is a details and delete button\n' +
...
const notUsedTestNotes =
  '- Verify there is no API icon showing on the left\n' +
  '- Verify API name is "' +
  apiName +
  '"\n' +
  '- Verify there is no API description\n' +
  '- Verify the usage message is "' +
  usedByZeroMsg +
  '"\n' +
  '- Verify there is a details and delete button\n' +
