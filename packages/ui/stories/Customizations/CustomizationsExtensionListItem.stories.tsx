...
import { CustomizationsExtensionListItem } from '../../src/Customizations';
import { extensionDetailStory } from './CustomizationsExtensionDetail.stories';

const stories = storiesOf('CustomizationsExtensionListItem', module);

const extensionId = 'Loop';
  ...
  .add(
    ...
    withNotes(inUseTestNotes)(() => (
      <CustomizationsExtensionListItem
        ...
        onDetails={linkTo('Customizations', extensionDetailStory)}
