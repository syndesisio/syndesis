...
const withIconTestNotes =
  ...
  apiDescription +
  '"\n' +
  '- Verify the usage message indicates 5 integrations\n' +
  '- Verify the delete button is enabled\n' +
  '- Verify clicking the delete button prints "' +
  apiConnectorId +
  '" in the ACTION LOGGER';

const withOutIconTestNotes = '- Verify no API icon is showing';

const usedByZeroTestNotes =
  '- Verify the usage message indicates zero integrations\n' +
  ...
  .add(
    ...
    withNotes(withIconTestNotes)(() => (
      <CustomizationsApiConnectorListItem
        ...
        onDelete={action(apiConnectorId)}
        usedBy={usedByFive}
      />
    ))
  )
