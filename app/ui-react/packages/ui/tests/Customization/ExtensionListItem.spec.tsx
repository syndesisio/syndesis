...
export default describe('ExtensionListItem', () => {
  ...
  it('Should render correctly for in-use extension', () => {
    ...
    const { getByText, queryAllByAltText, queryAllByText } = render(comp);
    ...
    // icon alt text
    expect(queryAllByAltText(extensionName)).toHaveLength(1);
  ...
  it('Should render correctly for NOT in-use extension', () => {
    ...
    const { getByRole, getByText, queryAllByAltText, queryAllByText } = render(
      comp
    );
