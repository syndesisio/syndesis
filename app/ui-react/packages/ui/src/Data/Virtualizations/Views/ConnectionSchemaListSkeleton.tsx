...
import './ConnectionSchemaListSkeleton.css';

export interface IConnectionSchemaListSkeletonProps {
  width: number;
}

export const ConnectionSchemaListSkeleton: React.FunctionComponent<
  IConnectionSchemaListSkeletonProps
> = ({ width }) => (
  <ContentLoader
    className={'connection-schema-list-skeleton'}
    height={356}
    width={width}
    speed={2}
    primaryColor="#f3f3f3"
