...
const roleExistsText = 'A role with this name already exists - using the existing role.';
const roles = ['Developer', 'User', 'Admin'];

const updateRolePermissionModelActionText = 'Update role permission model action';
const deleteRoleFromPermissionModelActionText = 'Delete role from permission model action';
...
const sampleRolePermissionListNotes =
  ...
  '- Verify the role dropdown selections are: (' + roles + ')\n' +
  '- Verify icon to add role is shown at bottom with text "' + addNewRoleText + '"\n' +
