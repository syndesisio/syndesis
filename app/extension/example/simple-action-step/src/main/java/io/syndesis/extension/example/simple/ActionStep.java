...
@Action(
    id = "simple-action",
    name = "simple-action",
    description = "A simple Action for demo purpose",
    inputDataShape = @DataShape(
        kind = "java",
        type = "io.syndesis.extension.example.simple.ActionStep$In",
        metadata = {
    ...
    outputDataShape = @DataShape(
        kind = "java",
        type = "io.syndesis.extension.example.simple.ActionStep$Out",
        collectionType = "List",
