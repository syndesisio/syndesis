...
public class IntegrationRouteBuilderTest extends IntegrationTestSupport {
    ...
    public void testMultiFlowIntegrationRouteBuilder() throws Exception {
        ...
        assertThat(getOutput(primaryRoute, 0)).isInstanceOf(SetHeaderDefinition.class);
        ...
        assertThat(getOutput(primaryRoute, 1, 2).getOutputs()).hasSize(3);
        ...
        assertThat(getOutput(primaryRoute, 1, 2, 2)).isInstanceOf(ProcessDefinition.class);
        assertThat(getOutput(primaryRoute, 1, 3).getOutputs()).hasSize(4);
        assertThat(getOutput(primaryRoute, 1, 3, 0)).isInstanceOf(SetHeaderDefinition.class);
        assertThat(getOutput(primaryRoute, 1, 3, 1)).isInstanceOf(ProcessDefinition.class);
        assertThat(getOutput(primaryRoute, 1, 3, 2)).isInstanceOf(ChoiceDefinition.class);
        assertThat(getOutput(primaryRoute, 1, 3, 3)).isInstanceOf(ProcessDefinition.class);
        assertThat(getOutput(primaryRoute, 1, 4).getOutputs()).hasSize(3);
        ...
        assertThat(getOutput(primaryRoute, 1, 4, 2)).isInstanceOf(ProcessDefinition.class);
        ...
        assertThat(getOutput(conditionalRoute, 0)).isInstanceOf(SetHeaderDefinition.class);
        ...
        assertThat(getOutput(conditionalRoute, 3).getOutputs()).hasSize(3);
        ...
        assertThat(getOutput(conditionalRoute, 3, 2)).isInstanceOf(ProcessDefinition.class);
