...
@SpringBootTest(
    classes = {
        ...
        ComponentProxyFactoryTest.TestConfiguration.class,
        ComponentProxyFactoryTest.MyBean.class
    },
    properties = {
...
public class ComponentProxyFactoryTest {
    ...
    public static class MyFactory implements ComponentProxyFactory {
        ...
        public ComponentProxyComponent newInstance(String componentId, String componentScheme) {
            ComponentProxyComponent component = new ComponentProxyComponent(componentId, componentScheme);
            component.setBeforeProducer(
                e -> e.getIn().setBody(e.getIn().getBody(String.class) + " WORLD!")
            );
            component.setAfterProducer(
