...
import io.syndesis.connector.generator.swagger.UnifiedXmlDataShapeGenerator.SchemaPrefixAndElement;
...
public class UnifiedXmlDataShapeGeneratorTest {
    ...
    private static final Map<String, SchemaPrefixAndElement> NO_MORE_SCHEMAS = null;
