...
public class ActiveMQPingCheck {
    ...
    public void ping() throws Exception {
        ...
        Component connector = camel.getComponent("activemq-publish");
        Optional<ActiveMQConnectorVerifierExtension> ext = connector.getExtension(ActiveMQConnectorVerifierExtension.class);
        ...
        if (ext.isPresent()) {
            ...
            if (result.getStatus().equals(ComponentVerifierExtension.Result.Status.ERROR)) {
            ...
            if (result2.getStatus().equals(ComponentVerifierExtension.Result.Status.ERROR)) {
