...
public class Http4Verifier extends ComponentVerifier {

    public Http4Verifier() {
        super("http4", Http4ComponentVerifierExtension.class);
    }

    @Override
    protected ComponentVerifierExtension resolveComponentVerifierExtension(CamelContext context, String scheme) {
        return new Http4ComponentVerifierExtension(scheme, context);
    }
}
