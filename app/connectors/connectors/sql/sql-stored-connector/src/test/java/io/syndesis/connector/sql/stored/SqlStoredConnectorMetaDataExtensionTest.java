...
public class SqlStoredConnectorMetaDataExtensionTest {
    ...
    public void shouldFetchStoredProcedureMetadata() throws SQLException {
        ...
        final SqlStoredConnectorMetaDataExtension extension = new SqlStoredConnectorMetaDataExtension();

        final StoredProcedureMetadata metadata = extension.getStoredProcedureMetadata(connection, "catalog", "schema",
            "procedureName");
