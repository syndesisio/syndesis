...
import io.syndesis.connector.sql.stored.SqlStoredConnectorComponent;

@Configuration
@EnableConfigurationProperties(SqlStoredConnectorConnectorConfiguration.class)
public class SqlStoredDataSourceCustomizer implements ConnectorCustomizer<SqlStoredConnectorComponent> {

    @Autowired
    private SqlStoredConnectorConnectorConfiguration configuration;

    @Override
    public void customize(SqlStoredConnectorComponent component) {
