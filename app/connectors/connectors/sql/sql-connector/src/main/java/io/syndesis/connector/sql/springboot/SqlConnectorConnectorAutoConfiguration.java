...
public class SqlConnectorConnectorAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(SqlConnectorConnectorAutoConfiguration.class);
    @Autowired
    ...
    private List<ConnectorCustomizer<SqlConnectorComponent>> customizers;
    ...
    @PostConstruct
    public void postConstructSqlConnectorComponent() {
        Map<String, Object> parameters = new HashMap<>();
