...
public class SalesforceUpdateSObjectComponent extends UpdatingSalesforceConnector {
    ...
    public SalesforceUpdateSObjectComponent(final String componentSchema) {
        super("salesforce-update-sobject", componentSchema, SalesforceUpdateSObjectComponent.class);
    }
}
