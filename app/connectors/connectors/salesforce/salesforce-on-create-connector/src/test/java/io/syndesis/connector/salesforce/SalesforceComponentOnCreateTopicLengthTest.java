...
public class SalesforceComponentOnCreateTopicLengthTest {

    private final CamelContext context = new DefaultCamelContext();

    @Test
    public void testTopicLength() throws Exception {
    	SalesforceOnCreateComponent component = new SalesforceOnCreateComponent();
        ...
        assertTrue(options.get("topicName").equalsIgnoreCase("syndesis_superlongvalue_c"));
    }
