 ...
 */
@ContextConfiguration(classes = TodoApiV2ApiKeyInHeader_IT.EndpointConfig.class)
public class TodoApiV2ApiKeyInHeader_IT extends SyndesisIntegrationTestSupport {
    ...
    public static SyndesisIntegrationRuntimeContainer integrationContainer = new SyndesisIntegrationRuntimeContainer.Builder()
                            ...
                            .fromExport(TodoApiV2ApiKeyInHeader_IT.class.getResource("TodoApiV2ApiKeyInHeader-export"))
