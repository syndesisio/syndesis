...
public class WrapInDoubleQuotesFix extends AbstractQuickfix {

    @Override
    public List<CodeAction> createCodeActions(CodeActionParams params, DdlAnalyzerException exception) {
        List<CodeAction> actions = new ArrayList<>();

        CodeAction codeAction = new CodeAction("Wrap the value: " + exception.getTargetedString() + " in double quotes?");
