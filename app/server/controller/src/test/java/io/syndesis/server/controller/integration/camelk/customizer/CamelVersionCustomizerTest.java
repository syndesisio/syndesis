...
public class CamelVersionCustomizerTest {
    @Test
    public void testCamelVersionCustomizer() {
        ...
        assertThat(i.getSpec().getTraits().get("camel").getConfiguration()).containsOnly(
            entry("version", versionService.getCamelVersion()),
            entry("runtime-version", versionService.getCamelkRuntimeVersion())
        );
    }
}
