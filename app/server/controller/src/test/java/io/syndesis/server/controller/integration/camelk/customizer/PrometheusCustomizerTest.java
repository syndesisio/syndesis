...
public class PrometheusCustomizerTest {
    ...
    public void testPrometheusCustomizer() {
        ...
        CamelKIntegrationCustomizer customizer = new PrometheusCustomizer();
        ...
        assertThat(i.getSpec().getTraits().get("prometheus").getConfiguration()).containsOnly(
            entry("enabled", "true"),
            entry("port", "9779"),
            entry("service-monitor", "false")
        );
    }
}
