...
public class DataManagerTest {
    ...
    public void getConnectors() {
        ...
        assertThat(connectors.getItems().stream().map(Connector::getId).map(Optional::get))
            .containsExactlyInAnyOrder("activemq", "amqp", "ftp","sftp", "sql", "salesforce", "twitter", "aws-s3", "mqtt", "http4", "https4", "dropbox");
    ...
    public void getConnectorsWithFilterFunction() {
        ...
        Assert.assertEquals(12, connectors.getTotalCount());
