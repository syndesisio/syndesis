...
@SpringBootTest(
    properties = {
        ...
        "syndesis.route.definition.collector.enabled = false"
    },
    classes = {
        CamelAutoConfiguration.class,
        SyndesisAutoConfiguration.class,
        SyndesisExtensionCollectorAutoConfiguration.class,
        DisabledSyndesisExtensionCollectorAutoConfigurationTest.TestConfiguration.class
    }
)
public class DisabledSyndesisExtensionCollectorAutoConfigurationTest {
    @Autowired
    private CamelContext context;

    @Test
    public void test() {
        Assertions.assertThat(context.getRoute("extension-one")).isNull();
        Assertions.assertThat(context.getRoute("extension-two")).isNull();
    }
