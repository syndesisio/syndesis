...
public class SlackVerifier extends ComponentVerifier {

    public SlackVerifier() {
        super("slack", SlackVerifierExtension.class);
    }

    @Override
    protected ComponentVerifierExtension resolveComponentVerifierExtension(CamelContext context, String scheme) {
        return new SlackVerifierExtension(scheme, context);
    }
}
