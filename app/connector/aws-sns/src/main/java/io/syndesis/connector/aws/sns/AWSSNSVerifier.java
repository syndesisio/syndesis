...
public class AWSSNSVerifier extends ComponentVerifier {

    public AWSSNSVerifier() {
        super("aws-sns", AWSSNSVerifierExtension.class);
    }

    @Override
    protected ComponentVerifierExtension resolveComponentVerifierExtension(CamelContext context, String scheme) {
        return new AWSSNSVerifierExtension(scheme, context);
    }
