...
public class UTPasswordNoneIntegrationTest extends IntegrationTestBase {
    ...
    protected void createConnection() {
        connection = new Connection.Builder()
            ...
            .putConfiguredProperty(ConfigurationConstants.PASSWORD_TYPE, PasswordType.NONE.getValue())
            .putConfiguredProperty(ADD_TIMESTAMP, "false")
            .putConfiguredProperty(ConfigurationConstants.ADD_USERNAMETOKEN_NONCE, "false")
            .putConfiguredProperty(ConfigurationConstants.ADD_USERNAMETOKEN_CREATED, "false")
