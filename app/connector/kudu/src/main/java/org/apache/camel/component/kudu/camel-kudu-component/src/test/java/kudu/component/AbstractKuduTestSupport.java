...
import kudu.component.api.KuduApiTable;
...
public class AbstractKuduTestSupport extends CamelTestSupport {
     ...
     * @return KuduApiTable ready to be used for inserting a table in kudu
     */
    protected KuduApiTable createTestKuduApiTable(String name) {
        /**
        ...
        return new KuduApiTable(name, schema, cto);
    }
    ...
    protected void createTestTable(String tableName) {
        KuduClient client = ((KuduComponent) context().getComponent("kudu")).getClient();
        KuduApiTable apiTable = createTestKuduApiTable(tableName);
        if (this.testTable != null) {
            try {
