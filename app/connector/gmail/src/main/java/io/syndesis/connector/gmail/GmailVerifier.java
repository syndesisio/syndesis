...
public class GmailVerifier extends ComponentVerifier {

    public GmailVerifier() {
        super("google-mail", GmailVerifierExtension.class);
    }

    @Override
    protected ComponentVerifierExtension resolveComponentVerifierExtension(CamelContext context, String scheme) {
        return new GmailVerifierExtension(scheme, context);
    }
