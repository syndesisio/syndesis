...
public class ReceiveEMailVerifier extends ComponentVerifier {

    public ReceiveEMailVerifier() {
        super("email", ReceiveEMailVerifierExtension.class);
    }

    @Override
    protected ComponentVerifierExtension resolveComponentVerifierExtension(CamelContext context, String scheme) {
        return new ReceiveEMailVerifierExtension(scheme, context);
    }
}
