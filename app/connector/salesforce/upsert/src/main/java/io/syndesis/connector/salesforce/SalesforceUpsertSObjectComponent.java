...
public class SalesforceUpsertSObjectComponent extends UpdatingSalesforceConnector {
    ...
    public SalesforceUpsertSObjectComponent(final String componentSchema) {
        super("salesforce-upsert-sobject", componentSchema, SalesforceUpsertSObjectComponent.class);
    }
