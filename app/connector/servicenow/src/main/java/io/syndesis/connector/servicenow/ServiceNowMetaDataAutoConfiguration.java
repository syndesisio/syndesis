...
public class ServiceNowMetaDataAutoConfiguration {
    @Bean("servicenow-adapter")
    @Scope(ConfigurableBeanFactory.SCOPE_SINGLETON)
    @Lazy
    @ConditionalOnProperty(prefix = "io.syndesis.connector.servicenow.meta", name = "enabled", matchIfMissing = true)
    public MetadataRetrieval serviceNowMetaDataAdapter() {
        return new ServiceNowMetadataRetrieval();
    }
}
