...
public class ServiceNowVerifierAutoConfiguration {

    @Bean("servicenow")
    @Scope(ConfigurableBeanFactory.SCOPE_SINGLETON)
    @Lazy
    @ConditionalOnProperty(prefix = "io.syndesis.connector.servicenow.verifier", name = "enabled", matchIfMissing = true)
    public Verifier serviceNowVerifier() {
        return new ComponentVerifier("servicenow");
    }
}
