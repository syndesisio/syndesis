...
public class ClientPropertySerializer extends StdSerializer<ClientProperty> {
    ...
    public ClientPropertySerializer(Class<ClientProperty> t) {
        super(t);
    }
    ...
    @Override
    public void serialize(ClientProperty property, JsonGenerator generator, SerializerProvider provider) throws IOException {
