...
public class AWSSQSVerifier extends ComponentVerifier {

    public AWSSQSVerifier() {
        super("aws-sqs", AWSSQSVerifierExtension.class);
    }

    @Override
    protected ComponentVerifierExtension resolveComponentVerifierExtension(CamelContext context, String scheme) {
        return new AWSSQSVerifierExtension(scheme, context);
    }
