...
import io.syndesis.connector.activemq.ActiveMQSubscribeComponent;
...
@EnableConfigurationProperties(ActiveMQSubscribeConnectorConfiguration.class)
public class ActiveMQSubscribeConnectorAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(ActiveMQSubscribeConnectorAutoConfiguration.class);
    @Autowired
    private ApplicationContext applicationContext;
    @Autowired
    private CamelContext camelContext;
    @Autowired
    private ActiveMQSubscribeConnectorConfiguration configuration;
    @Autowired(required = false)
    private List<ConnectorCustomizer<ActiveMQSubscribeComponent>> customizers;
