...
public class GoogleCalendarVerifier extends ComponentVerifier {

    public GoogleCalendarVerifier() {
        super("google-calendar", GoogleCalendarVerifierExtension.class);
    }

    @Override
    protected ComponentVerifierExtension resolveComponentVerifierExtension(CamelContext context, String scheme) {
        return new GoogleCalendarVerifierExtension(scheme, context);
    }
