import { AppContext, IAppContext, IAppSettings } from '@syndesis/app/app/AppContext';
...
import { ConnectionsModule, DashboardModule, IntegrationsModule } from '@syndesis/app/modules';
