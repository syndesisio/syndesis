...
func (a *Install) Execute(client client.Client, syndesis *v1alpha1.Syndesis) error {
	...
	syndesisRoute, err := installSyndesisRoute(client, syndesis, list, autoGenerateRoute)
	if err != nil {
		return err
	}
	...
	if autoGenerateRoute {
		...
		err = removeAutoGeneratedAnnotation(client, syndesisRoute)
		if err != nil {
			return err
		}
	...
	for _, res := range list {
		...
		err = createOrReplace(client, res)
