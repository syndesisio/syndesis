 ...
 */
package com.redhat.ipaas.catalog;
...
public class CatalogExampleMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        catalog.addConnector("com.redhat.ipaas", "timer-connector", "0.2.0");
        catalog.addConnector("com.redhat.ipaas", "http-get-connector", "0.2.0");
        catalog.addConnector("com.redhat.ipaas", "http-post-connector", "0.2.0");
