    ...
    public void testConvert() throws Exception {
        Step step1 = new SimpleStep.Builder()
            ...
            .action(new Action.Builder()
                ...
                .camelConnectorGAV("io.syndesis:timer-connector:0.5.3")
                .build())
            .build();
        ...
        Step step2 = new SimpleStep.Builder()
            ...
            .action(new Action.Builder()
                ...
                .camelConnectorGAV("io.syndesis:http-get-connector:0.5.3")
                .build())
            .build();
        ...
        Step step4 = new SimpleStep.Builder()
            ...
            .action(new Action.Builder()
                ...
                .camelConnectorGAV("io.syndesis:http-post-connector:0.5.3")
                .build())
            .build();
