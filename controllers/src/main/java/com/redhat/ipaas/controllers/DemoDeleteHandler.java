...
public class DemoDeleteHandler implements WorkflowHandler {

    public static final Set<Integration.Status> DESIRED_STATE_TRIGGERS =
        Collections.unmodifiableSet(new HashSet<>(Arrays.asList(Integration.Status.Deleted)));
    ...
    public Integration execute(Integration integration) {
        ...
        Integration updatedIntegration = new Integration.Builder()
            ...
            .currentStatus(Integration.Status.Deleted)
