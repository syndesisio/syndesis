...
/**
 * A plain kotlin class which implements the funktion
 */
class Main {
     ...
     */
    fun wine(body : String?, @Header("name") name : String?) : String {
        return "Hello $name. I got payload `$body` and I am on host: $host"
    }
